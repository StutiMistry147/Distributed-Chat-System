...
def create_app(lifespan: Optional[Callable] = None) -> FastAPI:
    ...
    app.add_middleware(
        CORSMiddleware,
        allow_origins=["http://localhost:5173", "http://127.0.0.1:5173", "https://distributed-chat-system-production.up.railway.app", "https://discerning-presence-production-fa0e.up.railway.app"],
